 ...
 * 
 */
public class GuiTableHandler extends DefaultHandler
{
    ...
    {
        text.reset();
        if ( qName.equals( GuiTableColumnListHandler.THIS_TAG_NAME ) )
        {
            DTableColumnList colList = new DTableColumnList();
            dTable.setTableColumnList( colList );

            GuiTableColumnListHandler handler = new GuiTableColumnListHandler( 
                colList, this, parser );
    ...
    public void endElement( String uri, String localName, String qName )
        throws SAXException
    {
        if ( qName.equals( "tableIdentifier" ) )
        {
            dTable.setTableIdentifier( text.toString() );
        }
